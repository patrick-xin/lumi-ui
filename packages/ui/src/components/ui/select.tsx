      ...
      >
        <BaseSelect.Popup
          className={cn(
            ...
            "outline outline-border dark:-outline-offset-1 animate-popup",
            "[&:not([data-side=none])]:max-h-(--available-height) min-w-(--anchor-width)",
            "data-[side=none]:data-ending-style:transition-none data-[side=none]:data-starting-style:transition-none data-[side=none]:data-starting-style:scale-100 data-[side=none]:data-starting-style:opacity-100",
            "data-[side=none]:min-w-[calc(var(--anchor-width)+var(--spacing))]",
            className,
          )}
