  ...
  ],
  {
    ...
    variants: {
      ...
      variant: {
        ...
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 dark:bg-destructive/60 focus-visible:outline-destructive focus-visible:outline-offset-2 focus-visible:ring-destructive/30",
        ghost:
