...
<div className="flex flex-col md:flex-row gap-4 md:justify-between">
  <CTACard title="Installation Guide" icon={<PlayIcon/>} description="Try components in mintues" href="/docs/installation"/>
  <CTACard title="Browse Components" icon={<DiamondIcon/>} href="/docs/components"/>
</div>
