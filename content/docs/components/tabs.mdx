...
Migrating your `Tabs` component from shadcn/ui is straightforward. Our component follows the naming conventions from its primitive library - **Base UI**, just as shadcn/ui follows the conventions from Radix UI. This results in two key differences.
...
If you prefer to keep using shadcn/ui naming convention and minimal style(without `variants`), copy code below:
