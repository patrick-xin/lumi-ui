...
Tailwind Variants has several ways to specify config options:
    ...
    Passing config to the tv function
    Creating a custom tv instance using createTV
    Modifying the defaultConfig variable
...
description: Whether to merge class names with the tailwind-merge library. It avoids having duplicate tailwind classes. (Recommended) see more here
