...
const inputVariants = cva(
  [
    "bg-transparent w-full min-w-0 rounded-md shadow-sm text-base md:text-sm border border-input cursor-text transition-[color,box-shadow,border,ring] appearance-none duration-150",
