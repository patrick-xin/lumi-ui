...
function Calendar({
  ...
  const startMonth =
    startMonthProp ??
    (hasYearDropdown
      ? new Date(startYear ?? currentYear - 100, 0, 1)
      : undefined);
  const endMonth =
    endMonthProp ??
    (hasYearDropdown ? new Date(currentYear, 11, 31) : undefined);
    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "text-muted-foreground rounded-(--cell-radius) flex items-center gap-1 text-sm  [&>svg]:text-muted-foreground [&>svg]:size-3.5",
        ...
        range_end: cn(
          "rounded-r-(--cell-radius) bg-muted relative after:bg-muted after:absolute after:inset-y-0 after:w-1/2 after:left-0 z-0 isolate",
          defaultClassNames.range_end,
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_start: cn(
          "rounded-l-(--cell-radius) bg-muted relative after:bg-muted after:absolute after:inset-y-0 after:w-1/2 after:right-0 z-0 isolate",
  ...
  return (
    <Button
      className={cn(
        ...
        "group-data-[focused=true]/day:outline group-data-[focused=true]/day:outline-offset-2 group-data-[focused=true]/day:outline-ring group-data-[focused=true]/day:ring-4 group-data-[focused=true]/day:ring-primary/30",
