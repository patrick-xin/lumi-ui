...
export function CodeBlockWrapper({
  ...
  return (
    <figure
       className={cn("relative flex flex-col rounded-md w-full max-w-full", className)}
       data-rehype-pretty-code-figure=""
       data-language={language}
       {...props}
    >
       {hasCaption ? (
          <div className="sticky top-0 z-20 flex items-center justify-between border-b bg-code text-code-foreground px-4 py-2">
