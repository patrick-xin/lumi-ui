...
:root {
  ...
  --chart-1: oklch(0.65 0.18 322);
  --chart-2: oklch(0.62 0.16 280);
  --chart-3: oklch(0.64 0.14 240);
  --chart-4: oklch(0.70 0.13 180);
  --chart-5: oklch(0.70 0.16 50);
...
.dark {
  ...
  --sidebar: oklch(0.15 0.01 298);
  --sidebar-foreground: oklch(0.86 0.02 293);
  --sidebar-accent: oklch(0.31 0.03 308);
  --sidebar-accent-foreground: oklch(0.95 0.02 308);
  --sidebar-border: oklch(0.3 0.03 293);
  --sidebar-ring: oklch(0.71 0.07 302);
}
```