...
| `indicatorIcon` | `React.ReactNode` | `<ChevronDownIcon />` | The indicator icon. If not provided, defaults to a chevron. |
...
| `indicatorIcon` | `React.ReactNode` | `<CheckIcon />` | Custom icon to show when the item is selected. |
