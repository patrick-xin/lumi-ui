...
Lumi UI exports all primitive components with minimal styles from Base UI to ensure maximum flexibility. Below is an example of how to compose Linear-style combobox by mixing pre-assembled components with raw primitives.
</Callout>
