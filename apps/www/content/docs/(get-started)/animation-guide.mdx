...
- **Form**: [Combobox](/docs/components/form-input/combobox), [Select](/docs/components/form-input/select)
- **Overlay**: [Context Menu](/docs/components/overlays-dialogs/context-menu), [Dropdown Menu](/docs/components/overlays-dialogs/dropdown-menu), [Popover](/docs/components/overlays-dialogs/popover), [Preview Card](/docs/components/overlays-dialogs/preview-card), [Tooltip](/docs/components/overlays-dialogs/tooltip)
- **Status**: [Toast](/docs/components/feedback-status/toast)
...
- **Dialogs**:
  - `animate-fade-zoom`: [Alert Dialog](/docs/components/overlays-dialogs/alert-dialog), [Command Menu](/docs/components/layout-nav/command-menu), [Dialog](/docs/components/overlays-dialogs/dialog) (`center`, `scrollable`)
  - `animate-fade`: All backdrops, [Dialog](/docs/components/overlays-dialogs/dialog) (`element-outside`, `responsive`, `stacked`)
- **Navigation**: [Navigation Menu](/docs/components/layout-nav/navigation-menu)

### Directional Animations
Used for edge-aligned [Sheet](/docs/components/overlays-dialogs/sheet) and [Dialog](/docs/components/overlays-dialogs/dialog) variants:
