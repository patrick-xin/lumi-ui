...
<Steps>
  ...
  <Step title="Add CSS Utilities">
   ...
   ```
    ...
    <Step title="Install All UI Components">
    ...
    `Toast` component requires some extra css setup. Please refer to [Toast Installation](/docs/components/feedback-status/toast#installation) for more details.
  </Step>
</Steps>
