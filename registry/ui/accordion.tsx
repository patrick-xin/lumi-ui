...
function AccordionHeader({
  ...
  return (
    <AccordionPrimitive.Header {...props} className="flex">
      {children}
...
function AccordionPanel({
  ...
  return (
    <AccordionPrimitive.Panel
      ...
      className="h-[var(--accordion-panel-height)] overflow-hidden text-base transition-[height] ease-out data-[ending-style]:h-0 data-[starting-style]:h-0"
      {...props}
    >
